...
<head>
    ...
    <style type="text/css">
        body {
            background-image: url("https://s-media-cache-ak0.pinimg.com/736x/5f/7e/2f/5f7e2f82064551eae0c6d06fefbb3713--design-ppt-waves.jpg");
        }
        #infoSection {
            float: right;
            /*padding: 10px;*/
...
<div class="panel panel-success">
        <div class="panel-heading"><b>Pic Upload</b></div>
        <div class="panel-body" id="uploadBody">
        <form class="form" role="form" method="post" action="web8.php?username=<?php echo $email;?>" enctype="multipart/form-data">
            ...
            <div class="input-group-btn">
              <button type="submit" class="btn btn-info" name="picUpload" value="Upload Image">
                <i class="glyphicon glyphicon-upload"></i>
              </button>
            </div>
            </div>
            <!-- <div class="form-group">
            <button type="submit" class="btn btn-info" name="picUpload" value="Upload Image">Upload</button>
            </div> -->
        </form>
        </div>
</div>
...
?>
<div class="panel panel-info" id="picPanel">
    <div class="panel-heading"><b>Your Pictures</b></div>
    <div class="panel-body">
        <table class="table table-hover" id="picLoaderHTML">
...
<script type="text/javascript">
        ...
        var Tdata = {};
        var deleteFunct = function(value1, index){
            // document.getElementById("sadd").value = "changed!" + value1;
            // console.log("----->HERER"+value1);
            var status = confirm("Are you sure you want to delete "+value1+" ?");
            if(status==true){
                // document.getElementById("td"+index).style.visibility = "hidden";
                picDeleter(value1);
                if(Tdata.deletion == "success"){
                    console.log("Deleted!");
                }else{
                    console.log("Some Abnormality!");
                }
            }
        };
        var userId = <?php echo $userId;?>;
        function picDeleter(value1){
            $.ajax({
                method: "GET",
                url: "deleter.php",
                data: {filename: value1, userId: userId},
